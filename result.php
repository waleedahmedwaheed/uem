...
<div class="page-wrapper">
	...
	$start_from = ($page-1) * 4; 
			...
			$qry = "SELECT * FROM event where result=1 order by e_id desc Limit $start_from, 4";
		 mysql_select_db($database_dbconfig, $dbconfig);
		...
		while($rows = mysql_fetch_assoc($results))
		{
			...
			$u_id 			= $rows["u_id"];
                    ...
                    <div class="post-item wow" data-animation="fadeInUp" data-animation-delay="300">
                        <!-- Post Title -->
                        <h2 class="wow fadeInUp"><a href="res_teams.php?e_id=<?php echo $e_id; ?>"><?php echo $e_name; ?></a></h2>
                        <div class="post wow fadeInUp">
                            <!-- Image -->
                            <a href="res_teams.php?e_id=<?php echo $e_id; ?>"><img style="width:100%" class="img-responsive"  
                            ...
                            <div class="post-content">	
                                ...
                                <p><?php echo $e_desc; ?></p>
                                <!-- Meta -->
                                <div class="posted-date"><?php echo date("jS F, Y", strtotime("$date")); ?>   /   <span>by</span> <a href="#"><?php echo get_title(u_id,$email); ?></a> </div>
                            </div>
                        </div>
                    </div><!-- End Post -->
		...
		<?php } ?>
                    ...
                    <div class="post-nav wow fadeInRight" data-animation="fadeInUp" data-animation-delay="300">
							...
							<?php 
$sql = "SELECT COUNT(e_id) FROM event where result=1"; 
mysql_select_db($database_dbconfig, $dbconfig);
