...
<div class="page-wrapper">
	...
	$start_from = ($page-1) * 4; 
			...
			$qry = "SELECT * FROM event where status=0 and c_id = 2 and voting = 1 order by e_id desc Limit $start_from, 4";
		 mysql_select_db($database_dbconfig, $dbconfig);
		...
		<?php } ?>
                    ...
                    <div class="post-nav wow fadeInRight" data-animation="fadeInUp" data-animation-delay="300">
							...
							<?php 
$sql = "SELECT COUNT(e_id) FROM event where status=0 and c_id = 2 and voting = 1"; 
mysql_select_db($database_dbconfig, $dbconfig);
