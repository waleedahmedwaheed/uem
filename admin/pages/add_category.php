<?php include("../../conn/db.php"); 
	...
	if(isset($_GET["c_id"]))
	{
		$insertSQL = "SELECT * FROM category where c_id = '".$_GET["c_id"]."'";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="save_cat.php">
                                        <div class="form-group">
                                            <label>Category Name</label>
                                            <input class="form-control" placeholder="Enter name" name="cname" value="<?php echo $cname; ?>">
                                        </div>
