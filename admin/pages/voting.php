...
{
		$qrys = "UPDATE event set voting='1' where e_id='$e_ids'";
					mysql_select_db($database_dbconfig, $dbconfig);
					mysql_query($qrys);
}
else if($id==6)
{
		$qrys = "UPDATE event set voting='0' where e_id='$e_ids'";
					mysql_select_db($database_dbconfig, $dbconfig);
					mysql_query($qrys);
}
            ...
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									                 <?php
				$insertSQL = "SELECT * FROM event where c_id = 2";
				mysql_select_db($database_dbconfig, $dbconfig);
				...
				$total = $rowc["total"];
								...
								<a href="view_teams.php?e_id=<?php echo $e_id; ?>"> <?php echo $total; ?> </a> 		
										...
										<td><?php switch ($voting) {
							case 0: ?>
								<a style="color:red;" href="?id=5&e_id=<?php echo $e_id; ?>"> Closed </a>
								<?php break;
							case 1: ?>
								<a style="color:green;" href="?id=6&e_id=<?php echo $e_id; ?>"> Open </a>
								<?php break; 
											} ?>
										</td>	
